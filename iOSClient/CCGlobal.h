...
// Session
#define k_domain_session_queue                          @"cn.asytech.Crypto-Cloud"

#define k_download_session                              @"cn.asytech.Crypto-Cloud.download.session"
#define k_download_session_foreground                   @"cn.asytech.Crypto-Cloud.download.sessionforeground"
#define k_download_session_wwan                         @"cn.asytech.Crypto-Cloud.download.sessionwwan"
#define k_upload_session                                @"cn.asytech.Crypto-Cloud.upload.session"
#define k_upload_session_wwan                           @"cn.asytech.Crypto-Cloud.upload.sessionwwan"
#define k_upload_session_foreground                     @"cn.asytech.Crypto-Cloud.upload.sessionforeground"

// OperationQueue
#define k_queue                                         @"cn.asytech.Crypto-Cloud.queue"
#define k_download_queue                                @"cn.asytech.Crypto-Cloud.download.queue"
#define k_download_queuewwan                            @"cn.asytech.Crypto-Cloud.download.queuewwan"
#define k_upload_queue                                  @"cn.asytech.Crypto-Cloud.upload.queue"
#define k_upload_queuewwan                              @"cn.asytech.Crypto-Cloud.upload.queuewwan"

// Service Key Share
#define k_serviceShareKeyChain                          @"Crypto Cloud"
#define k_metadataKeyedUnarchiver                       @"cn.asytech.syncclient.metadata"
